...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('vergi_dairesi', function ($row) {
                return $row->vergi_dairesi ? $row->vergi_dairesi : '';
            });
            $table->editColumn('banka_adi', function ($row) {
                return $row->banka_adi ? $row->banka_adi : '';
            });
            $table->editColumn('banka_iban_no', function ($row) {
                return $row->banka_iban_no ? $row->banka_iban_no : '';
            });
