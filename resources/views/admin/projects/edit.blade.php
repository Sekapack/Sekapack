                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('tarih') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tarih" id="tarih" value="{{ old('tarih', $project->tarih) }}" required>
                            @if($errors->has('tarih'))
                                <span class="help-block" role="alert">{{ $errors->first('tarih') }}</span>
                            @endif
