    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="tarih">{{ trans('cruds.project.fields.tarih') }}</label>
                <input class="form-control date {{ $errors->has('tarih') ? 'is-invalid' : '' }}" type="text" name="tarih" id="tarih" value="{{ old('tarih', $project->tarih) }}" required>
                @if($errors->has('tarih'))
                    <span class="text-danger">{{ $errors->first('tarih') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.tarih_helper') }}</span>
            </div>
            <div class="form-group">
