    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $client->country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company') ? 'is-invalid' : '' }}" type="text" name="company" id="company" value="{{ old('company', $client->company) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('skype') ? 'is-invalid' : '' }}" type="text" name="skype" id="skype" value="{{ old('skype', $client->skype) }}" required>
                @if($errors->has('skype'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text') ? 'is-invalid' : '' }}" type="text" name="text" id="text" value="{{ old('text', $client->text) }}">
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vergi_dairesi') ? 'is-invalid' : '' }}" type="text" name="vergi_dairesi" id="vergi_dairesi" value="{{ old('vergi_dairesi', $client->vergi_dairesi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banka_adi') ? 'is-invalid' : '' }}" type="text" name="banka_adi" id="banka_adi" value="{{ old('banka_adi', $client->banka_adi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banka_iban_no') ? 'is-invalid' : '' }}" type="text" name="banka_iban_no" id="banka_iban_no" value="{{ old('banka_iban_no', $client->banka_iban_no) }}">
