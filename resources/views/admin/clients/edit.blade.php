                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('company') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="company" id="company" value="{{ old('company', $client->company) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $client->phone) }}" required>
                            @if($errors->has('phone'))
                        ...
                        <div class="form-group {{ $errors->has('skype') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="skype" id="skype" value="{{ old('skype', $client->skype) }}" required>
                            @if($errors->has('skype'))
                        ...
                        <div class="form-group {{ $errors->has('text') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="text" id="text" value="{{ old('text', $client->text) }}">
                            @if($errors->has('text'))
                        ...
                        <div class="form-group {{ $errors->has('vergi_dairesi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="vergi_dairesi" id="vergi_dairesi" value="{{ old('vergi_dairesi', $client->vergi_dairesi) }}">
                        ...
                        <div class="form-group {{ $errors->has('banka_adi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="banka_adi" id="banka_adi" value="{{ old('banka_adi', $client->banka_adi) }}">
                        ...
                        <div class="form-group {{ $errors->has('banka_iban_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="banka_iban_no" id="banka_iban_no" value="{{ old('banka_iban_no', $client->banka_iban_no) }}">
