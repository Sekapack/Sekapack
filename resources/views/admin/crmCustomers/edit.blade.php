                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('musteriler') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="musteriler" id="musteriler" value="{{ old('musteriler', $crmCustomer->musteriler) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $crmCustomer->address) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $crmCustomer->email) }}" required>
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('website') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="website" id="website" value="{{ old('website', $crmCustomer->website) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description" required>{{ old('description', $crmCustomer->description) }}</textarea>
